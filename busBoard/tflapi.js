...
async function getPostCode(){
   ...
   do{
        ...
        i++;
    //clear    console.log(`i--->${i}  validStatus=${validStatus}`);
...
try {
    ...
    if(postCodeData.status===404) throw new Error("Enter a valid Post code to run this program!!!")
...
async function getStopCodeId(){
    ...
    try{
        ...
        if(stopPoints.length === 0) throw new Error("please enter nearby Busstops")
